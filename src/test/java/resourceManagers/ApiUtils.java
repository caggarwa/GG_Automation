...
public class ApiUtils  extends JsonValidationReporter{
	...
	//Sets base URI
	public static void setApiBaseURI (String baseURI) throws IOException{
		apiBaseURI =baseURI;
	...
	public static String getHTTPResponse() throws JSONException, IOException {
	...
	public static void validateCompleteJsonFileForPostResponse(String expectedJsonFilePath) throws IOException {
		...
		System.out.println("Expected Json: "+mapper.readTree(expectedJson.toString()).toString());
		System.out.println("Actual Json: "+ mapper.readTree(actualJson.toString()).toString());
	...
	public static List<Map<String,String>> getActualJsonResults(JSONObject actualJsonObj,List<Map<String,String>> apiDataMap) {
	...
	public static List<Map<String,String>> getJsonArrayResults(JSONObject actualJsonObj,String KeyName) {
		List<Map<String,String>> APIDataMap= new ArrayList<Map<String,String>>();
		Iterator<String> actualKeyIterator=actualJsonObj.keys();
		org.json.JSONArray actualJsonArray;
	...
	public static List<String> getJsonArrayResultsInList(JSONObject actualJsonObj,String KeyName) {
			...
			try {
				if (actualkey.contains(KeyName)) {
					if (validateIfJasonArray(actualJsonObj, actualkey)) {
						...
						//Traversing on the JASON Array
						for (int i=0; i<actualJsonArray.length(); i++) {
							APIDataList.add(actualJsonArray.getString(i));
						}
					}
				}
			}
